...
def build_excel_bytes(city_frames: dict[str, pd.DataFrame], date_from: str, date_to: str) -> bytes:
    ...
    with pd.ExcelWriter(output, engine='openpyxl') as writer:
        readme = pd.DataFrame([
            ...
            ['Логика поиска', 'Сервис пытается сам найти архивную страницу RP5 по названию города, затем получить station_id и загрузить архив.'],
            ['Важно', 'Если match_status = ambiguous/error/not_found, проверь название города или станцию вручную.'],
